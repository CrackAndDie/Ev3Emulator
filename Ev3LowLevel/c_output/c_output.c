...
void    cOutputSetTypes(char* pTypes)
{
	...
	w_motors_setData(TypeArr, sizeof(TypeArr));
}
...
UBYTE     cMotorGetBusyFlags(void)
{
	...
	w_motors_getBusyFlags(&test, &test2);
...
void      cOutputReset(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(ResetArr, sizeof(ResetArr));
	}
	else
	{
#ifndef    DISABLE_DAISYCHAIN_COM_CALL
...
void      cOutputStop(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(StopArr, sizeof(StopArr));
	}
	else
	{
#ifndef    DISABLE_DAISYCHAIN_COM_CALL
...
void      cOutputSpeed(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(SetSpeed, sizeof(SetSpeed));
	}
	else
	{
#ifndef    DISABLE_DAISYCHAIN_COM_CALL
...
void      cOutputPower(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(SetPower, sizeof(SetPower));
	}
	else
	{
#ifndef    DISABLE_DAISYCHAIN_COM_CALL
...
void      cOutputStart(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(StartMotor, sizeof(StartMotor));
		for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
		{
			if (Nos & (0x01 << Tmp))
			{
...
void      cOutputPolarity(void)
{
	...
	if (Layer == 0)
	{
		...
		w_motors_setData(Polarity, sizeof(Polarity));
	}
	else
	{
#ifndef    DISABLE_DAISYCHAIN_COM_CALL
...
void      cOutputStepPower(void)
{
	...
	if (0 == Layer)
	{
		...
		//	}
		//}
		w_motors_setData((DATA8*)&(StepPower.Cmd), sizeof(StepPower));
		for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
		{
			// Set calling id for all involved inputs
			if (StepPower.Nos & (0x01 << Tmp))
...
void      cOutputTimePower(void)
{
	...
	if (0 == Layer)
	{
		...
		//	}
		//}
		w_motors_setData((DATA8*)&(TimePower.Cmd), sizeof(TimePower));
		for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
		{
			// Set calling id for all involved inputs
			if (TimePower.Nos & (0x01 << Tmp))
...
void      cOutputStepSpeed(void)
{
	...
	if (0 == Layer)
	{
		...
		//	}
		//}
		w_motors_setData((DATA8*)&(StepSpeed.Cmd), sizeof(StepSpeed));
		for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
		{
			// Set calling id for all involved inputs
			if (StepSpeed.Nos & (0x01 << Tmp))
...
void      cOutputTimeSpeed(void)
{
	...
	if (0 == Layer)
	{
		...
		//	}
		//}
		w_motors_setData((DATA8*)&(TimeSpeed.Cmd), sizeof(TimeSpeed));
		for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
		{
			// Set calling id for all involved inputs
			if (TimeSpeed.Nos & (0x01 << Tmp))
...
void      cOutputStepSync(void)
{
	...
	if (2 == No)
	{
		if (0 == Layer)
		{
			...
			//	}
			//}
			w_motors_setData((DATA8*)&(StepSync.Cmd), sizeof(StepSync));
			for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
			{
				// Set calling id for all involved outputs
				if (StepSync.Nos & (0x01 << Tmp))
...
void      cOutputTimeSync(void)
{
	...
	if (2 == No)
	{
		if (0 == Layer)
		{
			...
			//	}
			//}
			w_motors_setData((DATA8*)&(TimeSync.Cmd), sizeof(TimeSync));
			for (Tmp = 0; Tmp < OUTPUTS; Tmp++)
			{
				// Set calling id for all involved outputs
				if (TimeSync.Nos & (0x01 << Tmp))
...
void      cOutputClrCount(void)
{
	...
	if (0 == Layer)
	{
		...
		w_motors_setData(ClrCnt, sizeof(ClrCnt));
