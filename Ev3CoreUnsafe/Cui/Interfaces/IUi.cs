...
namespace Ev3CoreUnsafe.Cui.Interfaces
{
    ...
    public unsafe struct UI_GLOBALS
    {
        ...
        public LCD LcdSafe = *CommonHelper.PointerStruct<LCD>();
        public LCD LcdSave = *CommonHelper.PointerStruct<LCD>();
        public LCD* LcdPool;
        public LCD LcdBuffer = *CommonHelper.PointerStruct<LCD>();
        public LCD* pLcd;

        public UI UiSafe = *CommonHelper.PointerStruct<UI>();
        public UI* pUi;

        public ANALOG Analog = *CommonHelper.PointerStruct<ANALOG>();
        public ANALOG* pAnalog;

        public NOTIFY Notify = *CommonHelper.PointerStruct<NOTIFY>();
        public TQUESTION Question = *CommonHelper.PointerStruct<TQUESTION>();
        public IQUESTION IconQuestion = *CommonHelper.PointerStruct<IQUESTION>();
        public BROWSER Browser = *CommonHelper.PointerStruct<BROWSER>();
        public KEYB Keyboard = *CommonHelper.PointerStruct<KEYB>();
        public GRAPH Graph = *CommonHelper.PointerStruct<GRAPH>();
        public TXTBOX Txtbox = *CommonHelper.PointerStruct<TXTBOX>();
