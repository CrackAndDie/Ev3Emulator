...
extern "C" {
	...
	/* custom shite */
	static int mkdir(const char* dirname, int mode);
...
/* Internal utility functions */
	...
	*/
	...
	{
		// _mkdir(dirname);
		int isCreated = CreateDirectory(dirname, NULL);
		if (ERROR_ALREADY_EXISTS == GetLastError())
		{
			return 17; // because #define EEXIST      17  /* File exists */ in unix
		}
		return isCreated ? 0 : 1; // because mkdir returns 0 on success
	}
